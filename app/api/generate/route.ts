...
「目前公式沒有明顯錯誤，可以正常使用。」
- warning 可提醒：
「若結果與預期不同，可能是資料內容、格式、隱藏字元或空白造成，而不是公式本身。」

只有下列情況才允許回傳 status = "needs_info"：
...
若使用 RIGHT 搭配 FIND，長度必須使用：

LEN(儲存格) - FIND("符號", 儲存格)

不要再額外減 1，否則會少抓符號後的第一個字元。
