...
export const iferrorVlookupContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"需要安全又清楚的查找公式？",ctaText:"描述查詢欄位、資料範圍與找不到時的提示，EveryFormula 會建立組合公式。",ctaButton:"建立組合公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Need a safer lookup formula?",ctaText:"Describe the lookup field, data table, and fallback message and EveryFormula will build the combined formula.",ctaButton:"Create a combined formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"安全な検索数式が必要ですか？",ctaText:"検索列、データ範囲、該当なし表示を説明すると EveryFormula が組み合わせ数式を作成します。",ctaButton:"組み合わせ数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"需要安全清楚的查找公式？",ctaText:"描述查询字段、数据范围与未找到提示，EveryFormula 会创建组合公式。",ctaButton:"生成组合公式",back:"← 返回 Excel 教学中心",
  },
};
