...
export const metadata: Metadata = { title:"Excel IFS 函數教學｜多條件分級範例｜EverySheet", description:"學習 Excel IFS，取代巢狀 IF，完成成績、獎金與狀態分級。" };
export default function IfsGuidePage({ searchParams }:{ searchParams?:{ lang?:string } }) {
  ...
  return <GuideArticleLayout language={language} path="/guides/excel-ifs-function" content={ifsContent[language]} demo={guideDemos.ifs[language]} />;
}
