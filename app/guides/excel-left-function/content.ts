...
export const leftContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"文字代碼不知道怎麼拆？",ctaText:"提供原始文字與想保留的部分，EverySheet 會建立 LEFT 公式。",ctaButton:"建立文字公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Not sure how to split a code?",ctaText:"Provide the original text and desired portion and EverySheet will build the formula.",ctaButton:"Create a text formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"コードの分割方法が分かりませんか？",ctaText:"元の文字と必要部分を説明すると EverySheet が数式を作成します。",ctaButton:"文字列数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"文本代码不知道怎么拆？",ctaText:"提供原始文本与目标部分，EverySheet 会创建 LEFT 公式。",ctaButton:"生成文本公式",back:"← 返回 Excel 教学中心",
  },
};
