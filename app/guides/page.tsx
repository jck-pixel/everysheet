            ...
            <article key={category.title} style={styles.categoryCard} className="guides-category-card">
              ...
              <div style={styles.tagList} className="guides-tag-list">
                {category.items.map((item) => (
                  item === "IF" || item === "IFS" || item === "IFERROR" || item === "AND" || item === "OR" || item === "INDEX" || item === "MATCH" || item === "VLOOKUP" || item === "XLOOKUP" || item === "SUMIF" || item === "SUMIFS" || item === "COUNTIF" || item === "COUNTIFS" || item === "AVERAGEIF" || item === "DATEDIF" || item === "TODAY" || item === "NETWORKDAYS" ? (
                    <Link
                      key={item}
                            ...
                            : item === "SUMIFS"
                              ...
                              : item === "COUNTIFS"
                                ...
                                : item === "AVERAGEIF"
                                  ...
                                  : item === "DATEDIF" ? `/guides/excel-datedif-function?lang=${language}` : item === "TODAY" ? `/guides/excel-today-function?lang=${language}` : `/guides/excel-networkdays-function?lang=${language}`}
                      style={styles.tag}
