...
export const metadata: Metadata = { title: "Excel SUMIFS 函數教學｜多條件加總範例｜EverySheet", description: "學習 Excel SUMIFS 多條件加總，包括文字條件、日期區間、儲存格條件與常見錯誤。" };
...
export default function SumifsGuidePage({ searchParams }: { searchParams?: { lang?: string } }) {
  ...
  return <GuideArticleLayout language={language} path="/guides/excel-sumifs-function" content={sumifsContent[language]} demo={guideDemos.sumifs[language]} />;
}
