...
export const textContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"不知道格式代碼怎麼寫？",ctaText:"描述想要的日期、金額或編號樣式，EverySheet 會建立 TEXT 公式。",ctaButton:"建立格式公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Not sure which format code to use?",ctaText:"Describe the desired date, amount, or ID format and EverySheet will build the TEXT formula.",ctaButton:"Create a format formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"表示形式が分かりませんか？",ctaText:"希望の日付、金額、番号の形を説明すると EverySheet が TEXT 数式を作成します。",ctaButton:"書式数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"不知道格式代码怎么写？",ctaText:"描述想要的日期、金额或编号样式，EverySheet 会创建 TEXT 公式。",ctaButton:"生成格式公式",back:"← 返回 Excel 教学中心",
  },
};
