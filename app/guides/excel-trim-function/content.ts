...
export const trimContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"資料看起來一樣卻比對不到？",ctaText:"描述資料來源與異常情況，EveryFormula 會建立 TRIM 或清理公式。",ctaButton:"建立清理公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Values look identical but will not match?",ctaText:"Describe the data source and problem and EveryFormula will build a TRIM or cleanup formula.",ctaButton:"Create a cleanup formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"同じに見える値が一致しませんか？",ctaText:"データ元と問題を説明すると EveryFormula が TRIM や整理数式を作成します。",ctaButton:"整理数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"数据看起来一样却匹配不到？",ctaText:"描述数据来源与异常情况，EveryFormula 会创建 TRIM 或清理公式。",ctaButton:"生成清理公式",back:"← 返回 Excel 教学中心",
  },
};
