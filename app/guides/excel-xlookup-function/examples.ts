...
export const xlookupExamples: Record<AppLanguage, GuideDemo[]> = {
  "zh-TW": [
    ...
    {title:"範例四：同時傳回多欄",instruction:"只要在 B2 輸入公式，結果會自動延伸到 B2:D2，一次帶出姓名、部門與薪資。",headers:["A 查詢編號","B 姓名","C 部門","D 薪資","F 員工編號","G 姓名","H 部門","I 薪資"],rows:[["E002","王小美","行政部","42000","E001","陳小明","業務部","45000"],["","","","","E002","王小美","行政部","42000"],["","","","","E003","林大華","資訊部","52000"]],cell:"B2",formula:'=XLOOKUP(A2,F2:F4,G2:I4,"查無資料")',result:"王小美｜行政部｜42000"},
  ],
  en: [
    ...
    {title:"Example 4: Return multiple columns",instruction:"Enter the formula in B2 only; the results spill automatically across B2:D2 to return name, department, and salary.",headers:["A Lookup ID","B Name","C Department","D Salary","F Employee ID","G Name","H Department","I Salary"],rows:[["E002","Amy Wang","Admin","42000","E001","Alex Chen","Sales","45000"],["","","","","E002","Amy Wang","Admin","42000"],["","","","","E003","David Lin","IT","52000"]],cell:"B2",formula:'=XLOOKUP(A2,F2:F4,G2:I4,"Not found")',result:"Amy Wang | Admin | 42000"},
  ],
  ja: [
    ...
    {title:"例4：複数列を返す",instruction:"数式は B2 だけに入力します。結果は B2:D2 に自動展開され、氏名、部署、給与を返します。",headers:["A 検索番号","B 氏名","C 部署","D 給与","F 社員番号","G 氏名","H 部署","I 給与"],rows:[["E002","鈴木花子","管理部","42000","E001","山田太郎","営業部","45000"],["","","","","E002","鈴木花子","管理部","42000"],["","","","","E003","林大輔","IT部","52000"]],cell:"B2",formula:'=XLOOKUP(A2,F2:F4,G2:I4,"該当なし")',result:"鈴木花子｜管理部｜42000"},
  ],
  "zh-CN": [
    ...
    {title:"示例四：同时返回多列",instruction:"只需在 B2 输入公式，结果会自动扩展到 B2:D2，一次返回姓名、部门和工资。",headers:["A 查询编号","B 姓名","C 部门","D 工资","F 员工编号","G 姓名","H 部门","I 工资"],rows:[["E002","王小美","行政部","42000","E001","陈小明","销售部","45000"],["","","","","E002","王小美","行政部","42000"],["","","","","E003","林大华","信息部","52000"]],cell:"B2",formula:'=XLOOKUP(A2,F2:F4,G2:I4,"未找到")',result:"王小美｜行政部｜42000"},
  ],
};
