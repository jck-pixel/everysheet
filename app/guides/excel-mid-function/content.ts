...
export const midContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"不知道中間代碼從哪裡開始？",ctaText:"提供原始文字與想擷取的中段內容，EverySheet 會建立 MID 公式。",ctaButton:"建立文字公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Not sure where the middle code starts?",ctaText:"Provide the source text and desired section and EverySheet will build the MID formula.",ctaButton:"Create a text formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"中間コードの位置が分かりませんか？",ctaText:"元の文字と必要部分を説明すると EverySheet が MID 数式を作成します。",ctaButton:"文字列数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"不知道中间代码从哪里开始？",ctaText:"提供原始文本与目标部分，EverySheet 会创建 MID 公式。",ctaButton:"生成文本公式",back:"← 返回 Excel 教学中心",
  },
};
