...
export const substituteContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"大量資料要統一替換？",ctaText:"提供原始內容與替換規則，EveryFormula 會建立 SUBSTITUTE 公式。",ctaButton:"建立替換公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Need to standardize many values?",ctaText:"Provide the original content and replacement rule and EveryFormula will build the SUBSTITUTE formula.",ctaButton:"Create a replacement formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"大量データを統一しますか？",ctaText:"元の内容と置換ルールを説明すると EveryFormula が SUBSTITUTE 数式を作成します。",ctaButton:"置換数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"大量数据需要统一替换？",ctaText:"提供原始内容与替换规则，EveryFormula 会创建 SUBSTITUTE 公式。",ctaButton:"生成替换公式",back:"← 返回 Excel 教学中心",
  },
};
