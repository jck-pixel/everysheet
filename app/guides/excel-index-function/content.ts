...
export const indexContent: Record<AppLanguage, SumifsContent> = {
  "zh-TW": {
    ...
    ctaTitle:"不知道列數與範圍怎麼設定？",ctaText:"描述資料位置與想取出的內容，EverySheet 會建立 INDEX 公式。",ctaButton:"建立 INDEX 公式",back:"← 返回 Excel 教學中心",
  },
  en: {
    ...
    ctaTitle:"Not sure which row and range to use?",ctaText:"Describe your data and desired value and EverySheet will build the INDEX formula.",ctaButton:"Create an INDEX formula",back:"← Back to Excel Guides",
  },
  ja: {
    ...
    ctaTitle:"行番号や範囲が分かりませんか？",ctaText:"データ位置と取得内容を説明すると EverySheet が数式を作成します。",ctaButton:"INDEX 数式を作成",back:"← Excel 学習センターに戻る",
  },
  "zh-CN": {
    ...
    ctaTitle:"不知道行数与范围怎么设置？",ctaText:"描述数据位置与目标内容，EverySheet 会创建 INDEX 公式。",ctaButton:"生成 INDEX 公式",back:"← 返回 Excel 教学中心",
  },
};
